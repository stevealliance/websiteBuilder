...
`;let $s=t.InputComponent=(oi=(0,bo.Component)({animations:[_s()],changeDetection:bo.ChangeDetectionStrategy[zo],selector:'generic-input',template:`
        <generic-textarea
            ${Bs.wrapper}
    ...
    `}),_i=(0,bo.Input)(),Si=(0,bo.Input)(),Oi(Ci=(wi=class extends Rs{constructor(e){super(e),i(this,'labels',Di,this),i(this,'type',Ei,this)}},Di=r(wi.prototype,'labels',[_i],{enumerable:!0,initializer:function(){return{}}}),Ei=r(wi.prototype,'type',[Si],{enumerable:!0,initializer:function(){return this.type}}),wi))||Ci);Reflect.defineMetadata('design:paramtypes',[bo.Injector],Hs);let Ks=t.TextareaComponent=(zi=(0,bo.Component)({animations:[_s()],changeDetection:bo.ChangeDetectionStrategy[zo],selector:'generic-textarea',template:`
